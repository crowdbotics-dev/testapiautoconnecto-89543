...
## Project Structure
    ...
    ├── testapiautoconnecto_89543  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_89543`
...
2. Clone this repo and `cd testapiautoconnecto_89543`
